# To profile where time is spent, add at the very top of .zshrc:
zmodload zsh/zprof

# Add at the very bottom of .zshrc:
if [[ "${ZPROF}" == true ]]; then
    zprof
fi
...
# ZSH_AUTOSUGGEST_STRATEGY=(history)  # Removed completion to speed it up
